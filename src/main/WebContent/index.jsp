...
<main class="main">
  ...
  <div class="topbar">
    ...
    <div class="topbar-r">
      ...
      <button class="btn btn-p" onclick="location.href='logout'">
...
document.getElementById('chat-input').addEventListener('keydown', e => { if (e.key==='Enter') sendChat(); });
  ...
  div.innerHTML = `<div class="chat-av" style="background:var(--blue)">나</div><div class="chat-in"><div class="chat-nm">나 · 방금</div><div class="chat-bbl">${val}</div></div>`;
