...
<style>
    body { background-color:#f7f9fc;height:100vh;display:flex;justify-content:center;align-items:center; }
    .login-card { width:100%;max-width:400px;padding:2rem;border-radius:1rem;box-shadow:0 0 20px rgba(0,0,0,0.1);background-color:#ffffff; }
    .login-card h2 { text-align:center;margin-bottom:1.5rem;font-weight:600;color:#343a40; }
</style>
</head>
<body>
